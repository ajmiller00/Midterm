...
http.createServer(function (req, res) {
    ...
    //     		res.write("menuItems = new Array(new product('Extra Dark Chocolate Bar', 20), new product('Chilli Chocolate Bar', 20), new product('Hazelnut Swirl Chocolate Bar', 20),");
    //     		res.write("new product('Walnut Chocolate Bar', 20), new product('Caramel lover's Dream', 60), new product('Chocolate Caviar' , 50), new product('Coffee Infused Chocolate', 40),");
    //         	res.write("new product('PB&J Chocolate Chips', 40), new product('Random Mixed Chocolate' , 30), new product('Chocolate Dipped Fruit' , 65), new product('Bluberry Gourmet Chocolate' , 35),");
    //         	res.write("new product('Chocolate Covered Apricots' , 35), new product('Rêve au Chocolat Classic Truffles' , 28), new product('Three-Layer Truffles' , 30),");
    //         	res.write("new product('Strawberry Truffle', 30), new product('Bourbon Truffle', 30), new product('Cinnamon Truffle', 30), new product('Pistachio Truffle', 30),");
    //         	res.write("new product('Mystery Flavor Truffle', 30), new product('Coconut Truffle', 30), new product('72% Dark Chocolate Cupcakes', 30), new product('House Brownie', 30),");
    //         	res.write("new product('Chocolate Tiramisu Cake', 30), new product('Nutcracker', 10),);");
				// res.write("window.onload = function() { for (i = 0; i < menuItems.length; i++) { select = makeSelect('quan' + i, 0, 10); document.getElementsByName('product')[i].innerHTML = menuItems[i].name;");
    ...
    //     		res.write("document.getElementById('burger').style.display = 'none'; } } </script> </body> </html>");
